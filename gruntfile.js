...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    ftp: {
      ...
      upload1: {
        files: {
          '/17200/experiments/usatoday/2015/06/emoji-index/': 'js/main.js'
        }
      },
      upload2: {
        files: {
          '/17200/experiments/usatoday/2015/06/emoji-index/': 'style/project.css'
        }
      },
      upload3: {
        files: {
          '/17200/experiments/usatoday/2015/06/emoji-index/': 'data/*.json'
        }
      }
    },
